...
const GitHubStarButton = ({ starCount, isDark, version = 'V1.0.5' }) => {
  const theme = useTheme()

    const formattedStarCount = starCount.toLocaleString()

    return (
    <Link href='https://www.autodecora.com' target='_blank' underline='none' sx={{ display: 'inline-flex' }}>
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
      ...
      >
        ...
        >
          <svg height='16' width='16' viewBox='0 0 16 16' style={{ marginRight: '6px', fill: isDark ? '#c9d1d9' : '#24292e' }}>
            <path
              fillRule='evenodd'
